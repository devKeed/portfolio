...
const enhancedProjects: EnhancedProject[] = projectItems.map((project, index) => ({
  id: `project-${index}`,
  ...project,
  role: ["Fullstack Developer", "Frontend Developer", "Backend Developer", "Designer"][Math.floor(Math.random() * 4)],
  year: `${2022 + Math.floor(Math.random() * 4)}`,
  githubLink: project.name !== "Nitoons" ? "https://github.com/pledreDev" : "",
  ...
  category: ['fullstack', 'frontend', 'backend', 'design'][Math.floor(Math.random() * 4)]
}));
        ...
        >
          <motion.div variants={itemVariants}>
            <Typography
              ...
              gutterBottom
            >
              My <span style={{ color: "#8fff86" }}>Projects</span>
            </Typography>
            ...
            >
              Explore my portfolio of projects that showcase my technical skills and creative problem-solving abilities. Each project represents a unique challenge that I've tackled using modern technologies and best practices.
            </Typography>
          </motion.div>
            ...
            >
              <Tab 
                ...
                sx={{ 
                  ...
                  color: activeTab === "all" ? theme.palette.primary.main : 'inherit'
                }}
              />
              <Tab 
                label="Full-stack" 
                ...
                sx={{ 
                  ...
                  color: activeTab === "fullstack" ? theme.palette.primary.main : 'inherit'
                }}
              />
              <Tab 
                label="Frontend" 
                ...
                sx={{ 
                  ...
                  color: activeTab === "frontend" ? theme.palette.primary.main : 'inherit'
                }}
              />
              <Tab 
                label="Backend" 
                ...
                sx={{ 
                  ...
                  color: activeTab === "backend" ? theme.palette.primary.main : 'inherit'
                }}
              />
              <Tab 
                label="Design" 
                ...
                sx={{ 
                  ...
                  color: activeTab === "design" ? theme.palette.primary.main : 'inherit'
                }}
              />
            </Tabs>
          </Box>
                    ...
                    <motion.div variants={itemVariants}>
                      <Box
                        sx={{
                          borderRadius: '8px',
                          overflow: 'hidden',
                          border: `4px solid ${theme.palette.mode === 'dark' ? '#444' : '#eee'}`,
                          mb: 3
                        }}
                      >
                        <img
          ...
          <Box
            sx={{
              ...
              p: 4,
              textAlign: 'center',
              backgroundColor: isDarkMode ? 'rgba(143, 255, 134, 0.1)' : 'rgba(143, 255, 134, 0.2)',
              borderRadius: '8px',
            }}
            component={motion.div}
